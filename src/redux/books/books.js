...
export const fetchBooks = () => (dispatch) => {
  ...
  axios
    .get(
      'https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/6m4qINRqd72LA4PGpQAO/books',
    )
    .then((response) => {
...
export const removeBook = (id) => (dispatch) => {
  ...
  axios
    .delete(
      `https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/6m4qINRqd72LA4PGpQAO/books/${id}`,
      {
        item_id: id,
      },
    )
